  ...
  return  (
    <div className="w-full max-w-6xl m-5">
      ...
      <div className="bg-white border rounded-lg shadow-sm text-sm max-h-[80vh] min-h-[60vh] overflow-y-auto">
        ...
        {/* Header */}
        <div className="hidden sm:grid sm:grid-cols-[0.5fr_3fr_1fr_3fr_3fr_1fr_1fr] items-center py-4 px-6 border-b bg-gray-50 font-semibold text-gray-700 sticky top-0 hover:bg-gray-100">
          <p>#</p>
          <p>Patient</p>
          <p>Age</p>
          <p>Date & Time</p>
